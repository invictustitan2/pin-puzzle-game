...
- Beta testers: **\_\_\_**
- Total testers: **\_\_\_**
- Total sessions analyzed: **\_\_\_**

### Key Metrics Summary

| Metric                           | Target   | Actual    | Status        |
| -------------------------------- | -------- | --------- | ------------- |
| Avg completion time (all levels) | ~2 hours | **\_\_**  | ☐ Pass ☐ Fail |
| Avg resets per level             | 1-5      | **\_\_**  | ☐ Pass ☐ Fail |
| Drop-off rate after tutorial     | < 20%    | **\_\_**% | ☐ Pass ☐ Fail |
| Level 20 completion rate         | > 60%    | **\_\_**% | ☐ Pass ☐ Fail |
...
2. ***
3. ***
   Expected iteration time: **\_\_\_** weeks
